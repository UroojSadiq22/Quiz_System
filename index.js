...
const dataQuestions = [
    ...
    {
        question: "Which of the following can be used to compile TypeScript into JavaScript?",
        options: [
            "A) Node.js",
            "B) Babel",
    ...
    {
        question: "Which of the following TypeScript features is not available in JavaScript?",
        options: [
            "A) Classes",
            "B) Interfaces",
            "C) Arrow functions",
    ...
    {
        question: "Which keyword in TypeScript allows for creating a read-only property?",
...
async function quizQuestions() {
    ...
    console.log(chalk.blue("Correct Answers ="), chalk.yellow(`${correctAnswers}`));
